...
weight_tools::weight_tools(TString outname){
  ...
  // 2017 weight
  ...
  else if(outname_wt.Contains("RunIIAutumn18")) {
    w_pu_down  = vector<double>({0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 2.706e+00,
    ...
    w_pu_nom  = vector<double>({0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 2.290e+00,
    ...
    w_pu_up  = vector<double>({0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 0.000e+00, 1.961e+00,
